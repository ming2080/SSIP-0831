              ...
              <div className="lg:col-span-7 bg-white border border-slate-200 rounded-2xl p-5 shadow-2xs flex flex-col h-[650px] overflow-y-auto">
                {selectedPerson ? (
                  <div className="space-y-5">
                    {/* 人员详细头部卡片 (已移除重复分类标签，新增【播放轨迹过程】按钮) */}
                      ...
                      <div className="flex justify-between items-center flex-wrap gap-3">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 active:scale-98 rounded-xl shadow-xs transition-all cursor-pointer flex items-center gap-1.5 shrink-0"
                          >
